 ...
 */
public class AutoItemEdiText extends EditText {
    ...
    public AutoItemEdiText(Context context) {
        super(context);
    }

    public AutoItemEdiText(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public AutoItemEdiText(Context context, AttributeSet attrs, int defStyleAttr) {
